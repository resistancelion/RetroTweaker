...
import minetweaker.mc147.block.MCBlockDefinition;
import minetweaker.mc147.block.MCSpecificBlock;
import minetweaker.mc147.block.MCWorldBlock;
import minetweaker.mc147.data.NBTConverter;
import minetweaker.mc147.item.MCItemStack;
import minetweaker.mc147.oredict.MCOreDictEntry;
import minetweaker.mc147.player.MCPlayer;
import minetweaker.mc147.world.MCBiome;
import minetweaker.mc147.world.MCDimension;
...
public class MineTweakerMC {
	...
	public static IItemStack getIItemStackWildcard(Item item, int amount) {
		...
		return new MCItemStack(new ItemStack(item, 1, -1));
	}
	...
	public static IBlock getBlockAnyMeta(Block block) {
		return new MCSpecificBlock(block, -1);
	}
	...
	/**
	 * Retrieves the internal liquid stack of the given stack.
	 * 
	 * @param stack MT liquid stack
	 * @return MCF liquid stack
	 */
	public static LiquidStack getLiquidStack(ILiquidStack stack) {
		if (stack == null)
			return null;
		
		return (LiquidStack) stack.getInternal();
	}
