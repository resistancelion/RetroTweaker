...
package minetweaker.mc147.game;
...
import minetweaker.mc147.entity.MCEntityDefinition;
import minetweaker.mc147.item.MCItemDefinition;
import minetweaker.mc147.liquid.MCLiquidDefinition;
...
public class MCGame implements IGame {
	...
	public void signalLockError() {
		...
		if (Minecraft.isGuiEnabled()) {
			...
			/**
			 * Minecraft.getMinecraft().displayGuiScreen( new GuiCannotRemodify( "Minecraft has been
			 * tweaked for another server", "with modifications that cannot be rolled back.",
