package minetweaker.mc147.formatting;
...
public enum EnumChatFormatting {
   ...
   EnumChatFormatting(char c, boolean bl) {
...
public String toString() {
   ...
   public static EnumChatFormatting func_96300_b(String string) {
      return string == null ? null : (EnumChatFormatting)field_96331_x.get(string.toLowerCase());
   }

   public static Collection func_96296_a(boolean bl, boolean bl2) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         ...
         if ((!var6.func_96302_c() || bl) && (!var6.func_96301_b() || bl2)) {
