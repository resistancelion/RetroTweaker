...
package minetweaker.mc147.server;
...
public class ServerPlayer implements IPlayer {
	...
	public void sendChat(IChatMessage message) {
		DedicatedServer.getServer().sendChatToPlayer(message.getInternal().toString());
	}

	@Override
	public void sendChat(String message) {
		DedicatedServer.getServer().sendChatToPlayer(message);
	}
